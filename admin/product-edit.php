...
if (isset($_POST['form1'])) {
	...
	if (empty($_POST['p_name'])) {
		$valid = 0;
		$error_message .= "Nama Product can not be empty<br>";
	}
	...
	if ($valid == 1) {
		...
		if ($path == '') {
			...
			$statement->execute(array(
				...
				$_POST['p_qty'],
				$_POST['p_description'],
				isset($_POST['p_short_description']) ? $_POST['p_short_description']:NULL,
				isset($_POST['p_feature']) ? $_POST['p_feature']:NULL,
				$_POST['p_condition'],
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Nama Product <span>*</span></label>
							<div class="col-sm-4">
